...
knitr::include_graphics("/Users/marinaespinasse/github/ohi_norway_bookdown/pics/aqua_production_chart2.jpg", dpi = 700)
```
...
\begin{equation}
Tot.prod = \triangle Biomass + Harvest + Moved\ fish - Discard - Seeded\ smolts - Added\ fish
(\#eq:totprod) 
\end{equation}
