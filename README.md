This repositoru is for building an html-book on OHI Norway. THe book will explain the composition of sustainability goals, the data and the methods we used to calculate the goals.
